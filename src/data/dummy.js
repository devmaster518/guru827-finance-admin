...
export const EditorData = () => (
  <div>
    <h3>
      <b>Heeeeey, My name is Dennis,</b>
      <br /> I'm a 35 years old self-taught web-developer who absolutely LOVES
      to code and design web sites and applications. <br />
      I'm a JS guy, who happens to adore React! I just love exploring new things
      and learn new technologies in the process. To be short & honest, I'm a
      Tech guy! ;) who loves to work in teams and puts extra effort to get
      mentored by a seasoned, more expirenced developer <br />
      <b>This is my Portfolio Page.</b> please check it out: <br />
      <a href="https://devstar-resume-page-v2.vercel.app/" target="_blank">
        https://devstar-resume-page-v2.vercel.app/
      </a>{" "}
      <br />
      <b>This is my GitHub Page:</b> <br />
      <a href="https://github.com/devmaster518" target="_blank">
        https://github.com/devmaster518
      </a>{" "}
      <br />
      By the way, Feel free to contact me about a project or anything else, I'm
      available for you. <br />
      <b>Here's my Email address:</b> <br />
      <b>christendennis779@gmail.com</b> <br /> <br />
      EDIT ME! - This is just some text. Try React. React has been designed from
      the start for gradual adoption, and you can use as little or as much React
      as you need. Whether you want to get a taste of React, add some

      ...
      <div className="flex gap-10 flex-wrap justify-center drop-shadow-2xl mt-5">
        ...
        <div className="flex flex-row flex-wrap justify-center">
          ...
          >
            <div className="flex justify-between items-center mt-5">
              ...
              <div>
                <p className="text-2xl text-white font-semibold">$84,593.36</p>
          ...
          >
            <div className="flex justify-between items-center mt-5">
              ...
              <div>
                <p className="text-2xl text-white font-semibold">$65,287.82</p>
            ...
            <div className="flex justify-between items-center gap-2 flex-col">
              ...
              <div className="mt-10 w-72 md:w-400">
                {recentTransactions.map((item, index) => (
                  <div
                    key={index}
                    className="flex justify-between items-center mt-2 p-2 rounded-2xl hover:shadow-lg cursor-pointer"
                  >
        ...
        <div className="flex flex-wrap justify-center">
          <div className="md:w-400 bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl p-6 m-3 drop-shadow-2xl">
            ...
            <div className="mt-10">
              {weeklyStats.map((item, index) => (
                <div
                  key={index}
                  className="flex justify-between mt-4 w-full rounded-2xl hover:shadow-lg cursor-pointer p-2"
                >
                  <div className="flex gap-4">
                    <button
                      type="button"
          ...
          <div className="w-400 bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl p-6 m-3 drop-shadow-2xl overflow-hidden">
            <div className="flex justify-between">
              <p className="text-xl font-semibold">New Project's Branding</p>
              <button
                type="button"
            ...
            <div className="mt-2">
              <p className="text-md font-semibold my-3">Leaders on Project</p>
          ...
          {activityPosts.map((item, index) => (
            ...
            >
              <div className="flex justify-between">
                <p className="text-xl font-semibold">{item.topTitle}</p>
                <button
                  type="button"
                  className="text-xl font-semibold text-gray-500"
                >
              ...
              <div className="mt-10">
                ...
                <div className="mt-8">
                  <p className="text-lg font-semibold">{item.postTitle}</p>
                  <p className="text-gray-400">{item.postAuthor}</p>
                  <p className="mt-5 text-sm text-gray-400">{item.postText}</p>
